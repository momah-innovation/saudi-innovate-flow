...
export default function SystemSettings() {
  ...
  const handleSaveConfigurableLists = async () => {
    const settingsToSave = [
      ...
      { key: 'challenge_status_options', value: values.challengeStatusOptions },
      { key: 'partner_status_options', value: values.partnerStatusOptions },
      { key: 'partner_type_options', value: values.partnerTypeOptions },
      { key: 'partnership_type_options', value: values.partnershipTypeOptions },
      { key: 'expert_status_options', value: values.expertStatusOptions },
      { key: 'assignment_status_options', value: values.assignmentStatusOptions },
      { key: 'role_request_status_options', value: values.roleRequestStatusOptions },
      { key: 'user_status_options', value: values.userStatusOptions },
      { key: 'general_status_options', value: values.generalStatusOptions },
