...
export const translations = {
  ar: {
    ...
    userWorkspace: 'مساحة عملي',
    expertWorkspace: 'مساحة عمل الخبير',
    organizationWorkspace: 'مساحة عمل المؤسسة',
    partnerWorkspace: 'مساحة عمل الشريك',
    adminWorkspace: 'مساحة عمل الإدارة',
    managePersonalInnovationJourney: 'إدارة رحلتك الابتكارية الشخصية',
    manageExpertActivities: 'إدارة أنشطة الخبراء',
    manageOrganizationInnovation: 'إدارة مبادرات الابتكار التنظيمية',
    managePartnershipActivities: 'إدارة أنشطة الشراكة وحضور السوق',
    manageSystemAdministration: 'إدارة النظام والإشراف على المنصة',
  ...
  en: {
    ...
    managePersonalInnovationJourney: 'Manage your personal innovation journey',
    manageExpertActivities: 'Manage your expert evaluation activities',
    manageOrganizationInnovation: 'Manage your organization\'s innovation initiatives',
    managePartnershipActivities: 'Manage your partnership activities and marketplace presence',
    manageSystemAdministration: 'Manage system administration and platform oversight',
    collaborativeWorkspaceForTeams: 'Collaborative workspace for teams and projects',
    joinTeam: 'Join Team',
    searchWorkspace: 'Search workspace...',
    loadingWorkspace: 'Loading workspace...',
    myAssignments: 'My Assignments',
    teamSchedule: 'Team Schedule',
    upcomingEventsAndDeadlines: 'Upcoming events and deadlines',
    scheduleFeatureComingSoon: 'Schedule feature coming soon',
    ...
    // Team Management General
    generalTeamManagement: 'Team Management',
    manageTeams: 'Manage teams and collaborative projects',
    teamDirectory: 'Team Directory',
    loadingTeamData: 'Loading team data...',
    assignmentsFeatureComingSoon: 'Assignments feature coming soon',
    performanceFeatureComingSoon: 'Performance feature coming soon',
    manageTeamAssignmentsAndWorkload: 'Manage team assignments and workload',
    trackTeamPerformanceAndMetrics: 'Track team performance and metrics',
