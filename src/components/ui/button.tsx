  ...
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98] hover:scale-[1.02]",
  {
    variants: {
      variant: {
        ...
        default: "bg-primary text-primary-foreground hover:bg-primary-hover hover:text-primary-foreground active:bg-primary-active active:!text-primary-active-foreground shadow-sm hover:shadow-md active:shadow-sm border-0 font-semibold [&]:bg-[hsl(272,65%,22%)] [&]:text-white",
        primary: "bg-primary text-primary-foreground hover:bg-primary-hover hover:text-primary-foreground active:bg-primary-active active:!text-primary-active-foreground shadow-sm hover:shadow-md active:shadow-sm border-0 font-semibold [&]:bg-[hsl(272,65%,22%)] [&]:text-white",
