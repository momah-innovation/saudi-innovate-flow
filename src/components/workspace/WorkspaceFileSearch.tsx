...
export const WorkspaceFileSearch: React.FC<WorkspaceFileSearchProps> = ({
  ...
  const [searchResults, setSearchResults] = useState<FileSearchResult[]>([
    ...
    },
    {
      ...
      tags: [t('workspace.files.tags.presentation'), t('workspace.files.tags.clients'), t('workspace.files.tags.design')],
      version: 2,
    ...
    {
      id: '3',
      name: t('workspace.files.sample_search_file_3'),
      type: 'image/png',
      size: 1024000,
      uploadedBy: t('mock_data.sample_member_3'),
      uploadedAt: '2024-01-13T16:45:00Z',
      tags: [t('workspace.files.tags.design'), t('workspace.files.tags.project')],
      version: 1,
      isCollaborating: true,
