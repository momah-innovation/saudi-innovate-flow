-- Comprehensive migration to seed remaining empty tables, avoiding duplicates

-- 1. Campaign relationships (avoiding duplicates)
INSERT INTO campaign_challenge_links (campaign_id, challenge_id) 
SELECT '50793935-4861-4bb5-8645-d3c698402b1a', '65cafee8-48ab-40e2-bbf4-951ae4c03618'
WHERE NOT EXISTS (SELECT 1 FROM campaign_challenge_links WHERE campaign_id = '50793935-4861-4bb5-8645-d3c698402b1a' AND challenge_id = '65cafee8-48ab-40e2-bbf4-951ae4c03618')
UNION ALL
SELECT 'b756f28b-ec7f-4e52-a890-eeb04cc1bfe1', '63cafee8-48ab-40e2-bbf4-951ae4c03616'
WHERE NOT EXISTS (SELECT 1 FROM campaign_challenge_links WHERE campaign_id = 'b756f28b-ec7f-4e52-a890-eeb04cc1bfe1' AND challenge_id = '63cafee8-48ab-40e2-bbf4-951ae4c03616')
UNION ALL
SELECT '2ca80e4b-9ed5-48b3-9613-388a41b25a81', '64cafee8-48ab-40e2-bbf4-951ae4c03617'
WHERE NOT EXISTS (SELECT 1 FROM campaign_challenge_links WHERE campaign_id = '2ca80e4b-9ed5-48b3-9613-388a41b25a81' AND challenge_id = '64cafee8-48ab-40e2-bbf4-951ae4c03617');

INSERT INTO campaign_department_links (campaign_id, department_id) 
SELECT '50793935-4861-4bb5-8645-d3c698402b1a', 'a0f6d473-45d8-4681-a836-37ed317d8151'
WHERE NOT EXISTS (SELECT 1 FROM campaign_department_links WHERE campaign_id = '50793935-4861-4bb5-8645-d3c698402b1a' AND department_id = 'a0f6d473-45d8-4681-a836-37ed317d8151')
UNION ALL
SELECT 'b756f28b-ec7f-4e52-a890-eeb04cc1bfe1', 'a0f6d473-45d8-4681-a836-37ed317d8152'
WHERE NOT EXISTS (SELECT 1 FROM campaign_department_links WHERE campaign_id = 'b756f28b-ec7f-4e52-a890-eeb04cc1bfe1' AND department_id = 'a0f6d473-45d8-4681-a836-37ed317d8152')
UNION ALL
SELECT '2ca80e4b-9ed5-48b3-9613-388a41b25a81', 'a0f6d473-45d8-4681-a836-37ed317d8151'
WHERE NOT EXISTS (SELECT 1 FROM campaign_department_links WHERE campaign_id = '2ca80e4b-9ed5-48b3-9613-388a41b25a81' AND department_id = 'a0f6d473-45d8-4681-a836-37ed317d8151');

-- Continue with all other table seeding...
...
('fa80bed2-ed61-4c27-8941-f713cf050944', 'تحديث حالة الفكرة', 'تم قبول فكرتك للمرحلة التالية', 'idea_status', '{"new_status": "approved"}');

-- Insert success notification
INSERT INTO public.notifications (user_id, title, message, type, metadata)
VALUES (
  '8066cfaf-4a91-4985-922b-74f6a286c441',
  'تم إكمال عملية البذر النهائية',
  'تم بنجاح تعبئة المزيد من جداول قاعدة البيانات ببيانات تجريبية مترابطة',
  'success',
  '{"final_seeding": true, "tables_completed": "multiple"}'
);