-- Add more sample partnership opportunities
...
(
  ...
  'open',
  '{"arabic": "خبرة في تطوير حلول إنترنت الأشياء، شهادات الأمان الصناعي", "english": "IoT development expertise, industrial security certifications"}',
  '{"efficiency": "تحسين الكفاءة التشغيلية", "cost_savings": "توفير التكاليف", "scale": "تطبيق على نطاق واسع"}',
...
(
  ...
  'open',
  '{"arabic": "خبرة في الأمن السيبراني، شهادات دولية معتمدة", "english": "Cybersecurity expertise, certified international credentials"}',
  '{"security": "تعزيز الأمان الرقمي", "reputation": "سمعة حكومية قوية", "growth": "فرص نمو في القطاع الأمني"}',
...
(
  ...
  'open',
  '{"arabic": "خبرة في تطوير المدن الذكية، محفظة مشاريع ناجحة", "english": "Smart cities development expertise, successful project portfolio"}',
  '{"impact": "تأثير واسع على المجتمع", "visibility": "ظهور إعلامي قوي", "expansion": "فرص توسع إقليمية"}',
  '3b264813-966e-4734-8266-7be9d0508f75'
);

-- Add partner bookmarks table if it doesn't exist
CREATE TABLE IF NOT EXISTS partner_bookmarks (
...
-- Enable RLS on partner_bookmarks
ALTER TABLE partner_bookmarks ENABLE ROW LEVEL SECURITY;

-- Create RLS policy for partner bookmarks
CREATE POLICY "Users can manage their own partner bookmarks" ON partner_bookmarks
...
-- Create RLS policy for opportunity bookmarks
