-- Successfully fix Arabic translation keys
...
-- Update Arabic keys to English keys
...
-- Delete Arabic translation keys from system_translations using correct column name
DELETE FROM system_translations 
WHERE translation_key SIMILAR TO '%[^\x00-\x7F]%';
