-- Remove check constraints temporarily to allow migration
...
ALTER TABLE partnership_opportunities DROP CONSTRAINT IF EXISTS partnership_opportunities_status_check;
ALTER TABLE partnership_opportunities DROP CONSTRAINT IF EXISTS partnership_opportunities_visibility_check;
...
ALTER TABLE partnership_opportunities ADD CONSTRAINT partnership_opportunities_status_check 
CHECK (status IN ('status.open', 'status.closed', 'status.paused'));

ALTER TABLE partnership_opportunities ADD CONSTRAINT partnership_opportunities_visibility_check 
CHECK (visibility IN ('visibility.public', 'visibility.private', 'visibility.internal'));