...
('super_admin', '5', ARRAY['admin', 'role_manager', 'user_manager', 'expert', 'innovator']::app_role[]),
('admin', '4', ARRAY['role_manager', 'user_manager', 'expert', 'innovator']::app_role[]),
('role_manager', '3', ARRAY['expert', 'innovator']::app_role[]),
('user_manager', '3', ARRAY['expert', 'innovator']::app_role[]),
('expert', '2', ARRAY[]::app_role[]),
