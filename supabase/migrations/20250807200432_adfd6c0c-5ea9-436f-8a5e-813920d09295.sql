...
INSERT INTO system_settings (setting_key, setting_value, setting_category, data_type, default_value) VALUES
  -- Storage/File Management Settings
  ('file_type_options', '["صورة", "مستند", "فيديو", "صوت", "أخرى"]', 'storage', 'array', '["صورة", "مستند", "فيديو", "صوت", "أخرى"]'),
  ('file_size_categories', '["صغير (< 1 ميجابايت)", "متوسط (1-10 ميجابايت)", "كبير (> 10 ميجابايت)"]', 'storage', 'array', '["صغير (< 1 ميجابايت)", "متوسط (1-10 ميجابايت)", "كبير (> 10 ميجابايت)"]'),
  ('sort_options', '["الاسم", "التاريخ", "الحجم", "نوع الملف"]', 'storage', 'array', '["الاسم", "التاريخ", "الحجم", "نوع الملف"]'),
  
  -- Date range options
  ('date_range_options', '["اليوم", "هذا الأسبوع", "هذا الشهر", "هذا العام", "كل الأوقات"]', 'general', 'array', '["اليوم", "هذا الأسبوع", "هذا الشهر", "هذا العام", "كل الأوقات"]'),
  
  -- Idea maturity levels 
  ('idea_maturity_levels', '["فكرة", "نموذج أولي", "منتج أدنى قابل للتطبيق", "تجريبي"]', 'ideas', 'array', '["فكرة", "نموذج أولي", "منتج أدنى قابل للتطبيق", "تجريبي"]'),
  
  -- Idea status options
  ('idea_status_options', '["في الانتظار", "قيد المراجعة", "موافق عليها", "مرفوضة", "قيد التطوير", "منفذة"]', 'ideas', 'array', '["في الانتظار", "قيد المراجعة", "موافق عليها", "مرفوضة", "قيد التطوير", "منفذة"]'),

  -- Additional event settings
  ('event_format_options', '["افتراضي", "حضوري", "مختلط"]', 'events', 'array', '["افتراضي", "حضوري", "مختلط"]'),
  ('event_status_options', '["مجدول", "جاري", "مكتمل", "ملغي"]', 'events', 'array', '["مجدول", "جاري", "مكتمل", "ملغي"]')
