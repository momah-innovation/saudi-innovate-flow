-- Final migration to seed all remaining empty tables with correct structure
...
-- 3. Implementation tracker (using correct columns for challenges)
INSERT INTO implementation_tracker (challenge_id, sla_deadline, estimated_completion_date, implementation_owner_id, implementation_stage, completion_percentage, approved_budget, health_status, last_update_date, next_review_date) VALUES
('65cafee8-48ab-40e2-bbf4-951ae4c03618', '2024-12-31', '2024-11-30', '8066cfaf-4a91-4985-922b-74f6a286c441', 'planning', 25, 150000, 'on_track', '2024-01-29', '2024-02-05'),
('63cafee8-48ab-40e2-bbf4-951ae4c03616', '2024-10-31', '2024-09-30', 'fa80bed2-ed61-4c27-8941-f713cf050944', 'development', 60, 200000, 'on_track', '2024-01-29', '2024-02-12'),
('64cafee8-48ab-40e2-bbf4-951ae4c03617', '2024-08-31', '2024-07-31', 'cb18b70f-a8fb-4265-bed0-a086ed236c22', 'testing', 80, 100000, 'at_risk', '2024-01-29', '2024-02-01');
...
INSERT INTO opportunity_status (challenge_id, current_stage, stage_start_date, stage_owner_id, stage_notes, stage_completion_percentage) VALUES
('65cafee8-48ab-40e2-bbf4-951ae4c03618', 'assessment', '2024-01-15', '8066cfaf-4a91-4985-922b-74f6a286c441', 'تقييم الفرص المتاحة للتحدي', 30),
('63cafee8-48ab-40e2-bbf4-951ae4c03616', 'development', '2024-01-20', 'fa80bed2-ed61-4c27-8941-f713cf050944', 'تطوير الحلول المقترحة', 65);
...
-- 7. Event participant notifications
...
-- 12. Insights (linked to trend reports)
INSERT INTO insights (trend_report_id, insight_text_ar, insight_type, applicable_domains, actionability_score, extracted_by) VALUES
((SELECT id FROM trend_reports WHERE report_type = 'monthly' LIMIT 1), 'نمو ملحوظ في اعتماد تقنيات الذكاء الاصطناعي بنسبة 25% هذا الشهر', 'growth_trend', ARRAY['AI', 'Technology'], 8, '8066cfaf-4a91-4985-922b-74f6a286c441'),
((SELECT id FROM trend_reports WHERE report_type = 'quarterly' LIMIT 1), 'البلوك تشين يظهر إمكانيات واعدة في القطاع المالي', 'emerging_technology', ARRAY['Blockchain', 'Finance'], 7, 'fa80bed2-ed61-4c27-8941-f713cf050944');