-- Final seeding migration focusing on tables without enum constraints
...
('880e8400-e29b-41d4-a716-446655440006', 'energy_analysis.xlsx', '/attachments/energy_analysis.xlsx', 'application/vnd.ms-excel', 256000, '7946c490-2d7b-4c07-8d6f-af4c284b526e', 'تحليل استهلاك الطاقة', true);
