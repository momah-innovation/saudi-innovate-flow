...
-- Create role-based policies for events based on sensitivity level
CREATE POLICY "Public can view normal events" 
ON public.events 
FOR SELECT 
USING (
...
CREATE POLICY "Team members can view sensitive events" 
ON public.events 
FOR SELECT 
USING (
...
CREATE POLICY "Admins can view confidential events" 
ON public.events 
FOR SELECT 
USING (
