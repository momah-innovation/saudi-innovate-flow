-- Seed realistic team data using valid system values
...
-- Add some sample challenges with correct priority levels
...
('تحدي الذكاء الاصطناعي للخدمات الحكومية', 'تطوير حلول ذكاء اصطناعي لتحسين الخدمات الحكومية وتجربة المواطنين',
 'نشط', 'medium', 'تقنية', '2024-01-15', '2024-05-15', 800000, '8066cfaf-4a91-4985-922b-74f6a286c441'),
...
((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'), 
 ...
 'director', 30, 'نشط', '2024-01-15', '2024-01-15', '2024-06-30', 400, 120, 
...
((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'), 
 ...
 'strategic_advisor', 25, 'نشط', '2024-03-01', '2024-03-01', '2024-09-30', 300, 60, 
...
((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'), 
 ...
 'manager', 30, 'نشط', '2024-02-01', '2024-02-01', '2024-08-31', 350, 180, 
...
((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'), 
 ...
 'lead_manager', 30, 'مكتمل', '2024-01-20', '2024-01-20', '2024-07-20', 400, 420, 
...
((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'), 
 ...
 'strategic_lead', 15, 'نشط', '2024-01-15', '2024-01-15', '2024-05-15', 150, 50, 
...
((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'), 
 ...
 'project_manager', 20, 'نشط', '2024-02-01', '2024-02-01', '2024-06-01', 200, 80, 
...
((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'), 
 ...
 'keynote_speaker', 5, 'نشط', '2024-03-15', '2024-03-15', '2024-04-15', 20, 8, 
...
((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'), 
 ...
 'event_manager', 10, 'نشط', '2024-04-01', '2024-04-01', '2024-05-20', 80, 20, 
...
((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'), 
 ...
 'facilitator', 5, 'مكتمل', '2024-03-01', '2024-03-01', '2024-03-30', 30, 35, 
