-- Final corrected seeding migration with proper PostgreSQL array syntax
...
-- 8. User Invitations (using proper PostgreSQL array syntax)
...
('ahmed.alrashid@gov.sa', 'f07d24ff-a9e6-4a82-bfa0-483cdcb6930e', 'inv_token_1234567890abcdef', 'Ahmed Al-Rashid', 'أحمد الراشد', 'Innovation Department', 'Expert', ARRAY['expert'], 'sent', '2024-08-15 23:59:59'),
('fatima.almansouri@tech.sa', '71e0fb71-c8f6-455c-a10a-8ced61ca830a', 'inv_token_abcdef1234567890', 'Fatima Al-Mansouri', 'فاطمة المنصوري', 'Technology Department', 'Innovator', ARRAY['innovator'], 'pending', '2024-08-20 23:59:59');