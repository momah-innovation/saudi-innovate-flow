...
-- Enable RLS on opportunity_bookmarks if not already enabled
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'opportunity_bookmarks' AND policyname = 'Users can manage their own opportunity bookmarks') THEN
