...
((SELECT id FROM ideas WHERE title_ar = 'منصة التعليم الذكي' LIMIT 1), 
 (SELECT id FROM experts WHERE user_id = (SELECT id FROM profiles WHERE name = 'أحمد العلي') LIMIT 1),
 8, 7, 9, 8, 9, 6,
...
((SELECT id FROM ideas WHERE title_ar = 'نظام إدارة النفايات الذكي' LIMIT 1),
 (SELECT id FROM experts WHERE user_id = (SELECT id FROM profiles WHERE name = 'فاطمة السعدي') LIMIT 1),
 9, 8, 7, 9, 8, 7,
...
((SELECT id FROM ideas WHERE title_ar = 'تطبيق الصحة النفسية' LIMIT 1),
 (SELECT id FROM experts WHERE user_id = (SELECT id FROM profiles WHERE name = 'محمد الحارثي') LIMIT 1),
 7, 9, 8, 8, 7, 5,
...
((SELECT id FROM innovation_team_members WHERE user_id = (SELECT id FROM profiles WHERE name = 'أحمد العلي') LIMIT 1),
 'challenge', 
 (SELECT id FROM challenges WHERE title_ar LIKE '%التعليم%' LIMIT 1),
 'lead_evaluator', 25, 'active', '2024-01-15', '2024-01-15', 40),

((SELECT id FROM innovation_team_members WHERE user_id = (SELECT id FROM profiles WHERE name = 'فاطمة السعدي') LIMIT 1),
 'challenge',
 (SELECT id FROM challenges WHERE title_ar LIKE '%البيئة%' LIMIT 1), 
 'technical_advisor', 20, 'active', '2024-01-20', '2024-01-20', 30),

-- Campaign assignments  
((SELECT id FROM innovation_team_members WHERE user_id = (SELECT id FROM profiles WHERE name = 'محمد الحارثي') LIMIT 1),
 'campaign',
 (SELECT id FROM campaigns WHERE title_ar LIKE '%الرقمي%' LIMIT 1),
 'coordinator', 30, 'active', '2024-02-01', '2024-02-01', 50),

-- Event assignments
((SELECT id FROM innovation_team_members WHERE user_id = (SELECT id FROM profiles WHERE name = 'نور الزهراني') LIMIT 1),
 'event',
...
((SELECT id FROM ideas WHERE title_ar = 'منصة التعليم الذكي' LIMIT 1),
 ...
 (SELECT user_id FROM innovators WHERE user_id = (SELECT id FROM profiles WHERE name = 'علي المحمد') LIMIT 1)),
...
((SELECT id FROM ideas WHERE title_ar = 'نظام إدارة النفايات الذكي' LIMIT 1),
 ...
 (SELECT user_id FROM innovators WHERE user_id = (SELECT id FROM profiles WHERE name = 'مريم الأحمد') LIMIT 1)),
