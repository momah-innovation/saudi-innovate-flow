-- Final successful migration with all required fields
...
-- 7. User invitations (with correct column names and token)
...
('expert1@innovation.gov.sa', '8066cfaf-4a91-4985-922b-74f6a286c441', generate_invitation_token(), 'Dr. Sarah Ahmed', 'د. سارة أحمد', 'Technology Department', 'Senior Expert', ARRAY['domain_expert'], 'pending', '2024-03-01 23:59:59+00'),
('evaluator1@innovation.gov.sa', 'fa80bed2-ed61-4c27-8941-f713cf050944', generate_invitation_token(), 'Ahmed Ali', 'أحمد علي', 'Research Department', 'Research Analyst', ARRAY['evaluator'], 'sent', '2024-02-25 23:59:59+00');
