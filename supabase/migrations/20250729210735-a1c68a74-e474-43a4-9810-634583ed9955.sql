-- Comprehensive seeding with all correct table structures
-- Using only existing foreign keys and proper column names
...
-- 6. Opportunity Status (using challenge_id)
