...
INSERT INTO public.innovators (user_id, innovation_interests, preferred_communication, availability_status) VALUES
('11111111-1111-1111-1111-111111111111', ARRAY['تكنولوجيا المعلومات', 'الذكاء الاصطناعي'], 'email', 'available'),
('11111111-1111-1111-1111-111111111112', ARRAY['الطاقة المتجددة', 'الاستدامة'], 'phone', 'busy'),
('11111111-1111-1111-1111-111111111113', ARRAY['الصحة الرقمية', 'التطبيقات الطبية'], 'email', 'available'),
('11111111-1111-1111-1111-111111111114', ARRAY['التعليم التقني', 'التدريب المهني'], 'email', 'available'),
('11111111-1111-1111-1111-111111111115', ARRAY['الأمن السيبراني', 'حماية البيانات'], 'phone', 'available'),
('11111111-1111-1111-1111-111111111116', ARRAY['التجارة الإلكترونية', 'التسويق الرقمي'], 'email', 'busy'),
('11111111-1111-1111-1111-111111111117', ARRAY['الزراعة الذكية', 'التكنولوجيا الزراعية'], 'email', 'available'),
('11111111-1111-1111-1111-111111111118', ARRAY['النقل الذكي', 'اللوجستيات'], 'phone', 'available');
