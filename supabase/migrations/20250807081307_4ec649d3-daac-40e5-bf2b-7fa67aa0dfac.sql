-- Final batch of comprehensive translation keys (Fixed SQL syntax)
...
('toast.permission_error', 'You do not have permission to perform this action', 'ليس لديك صلاحية لتنفيذ هذا الإجراء', 'toast'),
...
('toast.passwords_dont_match', 'Passwords do not match', 'كلمات المرور غير متطابقة', 'toast'),
...
-- Component-specific missing keys 
