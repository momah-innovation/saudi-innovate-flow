-- Add remaining missing array settings with correct structure
INSERT INTO public.system_settings (setting_key, setting_value, data_type) VALUES
  ('challenge_statuses', '["draft", "published", "active", "closed", "archived", "completed"]', 'array'),
  ('challenge_types', '["technical", "administrative", "creative", "strategic", "operational"]', 'array'),
  ('expert_role_types', '["evaluator", "mentor", "reviewer", "advisor", "specialist"]', 'array'),
  ('evaluator_types', '["internal", "external", "peer", "expert", "automated"]', 'array'),
  ('experience_levels', '["beginner", "intermediate", "advanced", "expert"]', 'array'),
  ('idea_maturity_levels', '["concept", "prototype", "pilot", "ready", "implemented"]', 'array'),
  ('time_range_options', '["last_7_days", "last_30_days", "last_90_days", "last_6_months", "last_year", "all_time"]', 'array'),
  ('question_type_options', '["multiple_choice", "open_text", "rating", "ranking", "yes_no"]', 'array'),
  ('team_role_options', '["lead", "member", "specialist", "coordinator", "advisor"]', 'array'),
  ('team_specialization_options', '["innovation", "research", "development", "design", "strategy", "operations"]', 'array'),
  ('requestable_user_roles', '["innovator", "expert", "team_member", "reviewer"]', 'array'),
  ('role_request_justifications', '["expertise_demonstrated", "project_contribution", "domain_knowledge", "leadership_skills"]', 'array'),
  ('role_request_status_options', '["pending", "approved", "rejected", "under_review"]', 'array'),
  ('available_user_roles', '["innovator", "expert", "team_member", "admin", "reviewer", "evaluator"]', 'array'),
  ('campaign_theme_options', '["innovation", "sustainability", "digital_transformation", "customer_experience", "efficiency"]', 'array'),
  ('stakeholder_influence_levels', '["low", "medium", "high", "critical"]', 'array'),
  ('stakeholder_interest_levels', '["low", "medium", "high", "very_high"]', 'array')
