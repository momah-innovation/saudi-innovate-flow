-- Final successful migration for remaining tables
...
-- 2. Event participant notifications
...
('MODIFY', 'cb18b70f-a8fb-4265-bed0-a086ed236c22', 'domain_expert', '8066cfaf-4a91-4985-922b-74f6a286c441', 'تحديث مستوى الخبرة بناءً على الأداء'),
('ASSIGN', '157e3ce7-6e92-4a97-ad75-ef641234c307', 'evaluator', '8066cfaf-4a91-4985-922b-74f6a286c441', 'تعيين دور مقيم للمشاركة في تقييم الأفكار');

-- 7. User invitations (with correct column names)
INSERT INTO user_invitations (email, invited_by, name, name_ar, department, position, initial_roles, status, expires_at) VALUES
('expert1@innovation.gov.sa', '8066cfaf-4a91-4985-922b-74f6a286c441', 'Dr. Sarah Ahmed', 'د. سارة أحمد', 'Technology Department', 'Senior Expert', ARRAY['domain_expert'], 'pending', '2024-03-01 23:59:59+00'),
('evaluator1@innovation.gov.sa', 'fa80bed2-ed61-4c27-8941-f713cf050944', 'Ahmed Ali', 'أحمد علي', 'Research Department', 'Research Analyst', ARRAY['evaluator'], 'sent', '2024-02-25 23:59:59+00');
