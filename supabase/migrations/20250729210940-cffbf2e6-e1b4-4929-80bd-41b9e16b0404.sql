-- Final complete seeding for all remaining empty tables
-- Using proper table structures and existing foreign keys
...
('challenge', '65cafee8-48ab-40e2-bbf4-951ae4c03618', '8066cfaf-4a91-4985-922b-74f6a286c441', 'user', 'challenge_lead', 'active', 'قائد التحدي الرئيسي', NULL),
...
('organization', NULL, 'cb18b70f-a8fb-4265-bed0-a086ed236c22', 'user', 'innovation_mentor', 'active', 'مرشد الابتكار', '2025-07-29');
