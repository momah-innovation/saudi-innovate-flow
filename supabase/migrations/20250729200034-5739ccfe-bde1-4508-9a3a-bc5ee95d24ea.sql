-- Final working migration with correct enum values
...
-- 6. Role audit log (using correct enum values)
...
-- 7. User invitations (using correct enum values)
INSERT INTO user_invitations (inviter_id, invitee_email, role_requested, invitation_message, status, expires_at) VALUES
('8066cfaf-4a91-4985-922b-74f6a286c441', 'expert1@innovation.gov.sa', 'domain_expert', 'دعوة للانضمام كخبير في منصة الابتكار', 'pending', '2024-03-01 23:59:59+00'),
