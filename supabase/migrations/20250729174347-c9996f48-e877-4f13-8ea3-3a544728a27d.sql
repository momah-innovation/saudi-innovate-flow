-- Add team activities using correct column structure
-- First check what columns exist in team_activities table
...
INSERT INTO team_activities (
  ...
  hours_spent, activity_date, quality_rating, created_by
) VALUES 
...
((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'),
 'training', 'إجراء دورة تدريبية لفريق العمل حول أحدث اتجاهات الابتكار', 16, '2024-03-25', 5, 
 '8066cfaf-4a91-4985-922b-74f6a286c441'),
...
((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'),
 'reporting', 'إعداد التقارير الشهرية ومتابعة تقدم المشاريع والمبادرات', 8, '2024-04-01', 4, 
 '8066cfaf-4a91-4985-922b-74f6a286c441');
...
-- Update team member information with enhanced details
