-- Drop existing policies that might conflict and deploy comprehensive RLS policies
-- This migration handles conflicts by using DROP IF EXISTS

-- Drop existing policies that might conflict
DROP POLICY IF EXISTS "comprehensive_user_avatars_select" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_user_avatars_insert" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_user_avatars_update" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_user_avatars_delete" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_user_documents_all" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_temp_uploads_all" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_ideas_attachments_select" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_ideas_attachments_insert" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_ideas_attachments_update" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_ideas_attachments_delete" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_ideas_documents_select" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_ideas_documents_insert" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_ideas_documents_update" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_ideas_documents_delete" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_team_only_access" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_demo_private_access" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_public_buckets_select" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_public_buckets_insert" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_public_buckets_update" ON storage.objects;
DROP POLICY IF EXISTS "comprehensive_public_buckets_delete" ON storage.objects;
...
DROP POLICY IF EXISTS "Authenticated users can manage saved images" ON storage.objects;
DROP POLICY IF EXISTS "Public can view saved images" ON storage.objects;
