...
-- Insert sample enhanced opportunities with JSONB data
...
SELECT 
  ...
  '["خبرة في الذكاء الاصطناعي", "فريق تقني متخصص", "شراكة مع الجامعات", "رخصة تشغيل"]'::jsonb,
  '["تمويل يصل إلى 15 مليون ريال", "دعم تقني ومعرفي", "شراكة استراتيجية طويلة الأمد", "فرص توسع إقليمية"]'::jsonb,
  'high',
  'public',
  'الرياض، جدة، الدمام',
  '["شركات التقنية", "الجامعات ومراكز البحث", "المطورين المستقلين"]'::jsonb,
...
SELECT 
  ...
  '["سجل تجاري ساري", "خبرة في رعاية الفعاليات", "التزام بمعايير الجودة"]'::jsonb,
  '["تغطية إعلامية واسعة", "شبكة علاقات دولية", "فرص استثمارية جديدة"]'::jsonb,
  'high',
  'public',
  'المملكة العربية السعودية',
  '["الشركات الكبرى", "المؤسسات المالية", "الشركات الناشئة"]'::jsonb,
...
SELECT 
  ...
  '["شهادات أمان سيبراني", "خبرة في الأنظمة الحكومية", "فريق دعم محلي"]'::jsonb,
  '["عقود طويلة الأمد", "نقل المعرفة والتدريب", "شراكة حصرية"]'::jsonb,
  'high',
  'internal',
  'الرياض',
  '["شركات التقنية الكبرى", "بيوت الخبرة المحلية"]'::jsonb,
