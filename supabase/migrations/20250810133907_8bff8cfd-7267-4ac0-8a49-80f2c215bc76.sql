-- Complete Database Migration to Key-Based Translation System
-- Now that constraints are removed, perform the migration
...
SET 
  ...
  challenge_type = CASE challenge_type
    ...
    WHEN 'technical' THEN 'challenge_type.technical'
    WHEN 'business' THEN 'challenge_type.business'
    WHEN 'social' THEN 'challenge_type.social'
  ...
  sensitivity_level = CASE sensitivity_level
    ...
    WHEN 'عادي' THEN 'sensitivity.normal'
    WHEN 'عام' THEN 'sensitivity.public'
    WHEN 'داخلي' THEN 'sensitivity.internal'
    WHEN 'سري' THEN 'sensitivity.confidential'
    WHEN 'مقيد' THEN 'sensitivity.restricted'
...
('challenge_type.business', 'Business', 'أعمال', 'challenge_type'),
...
INSERT INTO public.system_audit_log (
  ...
  jsonb_build_object(
    'migration_type', 'key_based_translation_system_complete',
