-- Add team activities and assignments using existing data only
-- No new challenges, just activities for existing team members
...
-- Recent activities for existing team members
((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'),
 'planning', 'وضع الخطة الاستراتيجية لفريق الابتكار وتحديد المؤشرات الرئيسية للأداء', 12, '2024-01-20', 5, 'high', 
 '8066cfaf-4a91-4985-922b-74f6a286c441'),

((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'),
 'strategic_review', 'مراجعة استراتيجية الابتكار ووضع معايير التقييم الجديدة', 8, '2024-02-10', 5, 'high', 
 '8066cfaf-4a91-4985-922b-74f6a286c441'),

((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'),
 'coordination', 'تنسيق الأنشطة بين الأقسام المختلفة وإعداد التقارير الدورية', 10, '2024-03-15', 4, 'medium', 
 '8066cfaf-4a91-4985-922b-74f6a286c441'),

((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'),
 'training', 'إجراء دورة تدريبية لفريق العمل حول أحدث اتجاهات الابتكار', 16, '2024-03-25', 5, 'high', 
 '8066cfaf-4a91-4985-922b-74f6a286c441'),
...
((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'),
 'coordination', 'تنسيق اجتماعات الشركاء وإعداد خطة العمل التفصيلية للمشاريع', 15, '2024-02-05', 4, 'medium', 
 '8066cfaf-4a91-4985-922b-74f6a286c441'),

((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'),
 'project_management', 'إدارة تنفيذ عدة مشاريع متوازية وتنسيق فرق العمل', 20, '2024-03-01', 4, 'high', 
 '8066cfaf-4a91-4985-922b-74f6a286c441'),

((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'),
 'stakeholder_engagement', 'إدارة علاقات أصحاب المصلحة وتنظيم اللقاءات الدورية', 12, '2024-03-20', 5, 'high', 
 '8066cfaf-4a91-4985-922b-74f6a286c441'),

((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'),
 'reporting', 'إعداد التقارير الشهرية ومتابعة تقدم المشاريع والمبادرات', 8, '2024-04-01', 4, 'medium', 
 '8066cfaf-4a91-4985-922b-74f6a286c441');
...
-- Recent weeks for Director (8066cfaf...)
((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'),
...
((SELECT id FROM innovation_team_members WHERE user_id = '8066cfaf-4a91-4985-922b-74f6a286c441'),
 '2024-04-08', 40, 35, 88, 'overloaded', 38, 88),

-- Recent weeks for Senior Manager (fa80bed2...)
((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'),
...
((SELECT id FROM innovation_team_members WHERE user_id = 'fa80bed2-ed61-4c27-8941-f713cf050944'),
 '2024-04-08', 40, 28, 70, 'busy', 30, 90);

-- Update team member information with more realistic data
