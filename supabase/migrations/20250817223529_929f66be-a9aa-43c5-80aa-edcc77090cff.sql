-- Enhanced Workspace Database Migration (Corrected)
...
-- Enhance workspace_files table (using correct column names)
...
-- Enhanced RLS Policies for workspace_files (using correct column name)
...
CREATE INDEX IF NOT EXISTS idx_workspace_files_uploaded_by ON public.workspace_files(uploaded_by);
