-- Disable the idea version trigger to prevent null constraint errors during migration
ALTER TABLE ideas DISABLE TRIGGER create_idea_version_snapshot;
...
ALTER TABLE ideas ENABLE TRIGGER create_idea_version_snapshot;
