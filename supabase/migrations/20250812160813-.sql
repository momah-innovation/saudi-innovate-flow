-- =============================================
-- COMPLETE ORGANIZATIONAL HIERARCHY MIGRATION (FINAL)
...
-- 2. Add entity_id to all hierarchical tables that are missing it
...
-- 3. Create foreign key constraints for proper hierarchy
DO $$ 
BEGIN
...
-- 4. Create organization and organization_members tables
...
-- 5. Create focus_question_entity_links table
...
-- 6. Create focus_question_challenge_links table
...
-- 7. Create user_entity_assignments table
...
-- 8. Create team_entity_assignments table
